...
```text
# Loop observability — my-project · <person>
...
- **action_required** · ABC-1691: ABC-1691 is in awaiting-review for 5834 min (threshold 20 min)
- **action_required** · ABC-1692: ABC-1692 is in waiting-for-pr for 5811 min (threshold 20 min)
