export const HARNESS_ERROR_CODES = ['HARNESS_ERROR', 'INVALID_CONFIG', 'INVALID_INPUT', 'INVALID_STATE', 'POLICY_BLOCKED', 'CLARIFYING', 'STALE', 'WORKTREE_DIRTY', 'ACTIVE_RUN', 'NO_RUN', 'HUMAN_APPROVAL_REQUIRED', 'GIT_REQUIRED', 'TRACKER_READ_ONLY'] as const
