...
const kindFor = (modulePath) => modulePath.includes('/adapters/') ? 'adapter' : modulePath.startsWith('./execution/') || modulePath === './cli.js' ? 'execution' : modulePath === './index.js' || modulePath.startsWith('./loop/') ? 'composition' : 'kernel'
